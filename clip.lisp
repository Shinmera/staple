...
(defmethod clip ((package package) field)
  (case* string-equal field
...
(defmethod clip ((symbol symbol) field)
  (case* string-equal field
...
(defmethod clip ((definition definitions:definition) field)
  (case* string-equal field
...
(defmethod clip ((definition definitions:callable) field)
  (case* string-equal field
    (arguments (definitions:arguments definition))
    (T (call-next-method))))

(defmethod clip ((definition definitions:method) field)
  (case* string-equal field
