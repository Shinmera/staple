...
(defclass symb-setf-function (symb-object) ()
  (:documentation "Object representing a setf-function."))
(defclass symb-accessor (symb-function symb-setf-function) ()
...
(defgeneric symb-function (symb-object)
  ...
  (:method ((symb symb-setf-function))
    (fdefinition `(setf ,(symb-symbol symb)))))
...
(defgeneric symb-arguments (symb-object)
  ...
  (:method ((symb symb-setf-function))
    (arg:arglist `(setf ,(symb-symbol symb))))
...
or one of the symb-object types.")
  ...
  (:method ((symb symb-setf-function) (mask (eql :setf-function))) T)
  ...
  (let ((objs ()))
    (dolist (symbol symbols objs)
      (flet ((push-symb (class)
        ...
        (cond
          ((symbol-accessor-p symbol)
           (push-symb 'symb-accessor)
           (push-methods symbol)
           (push-methods `(setf ,symbol)))
          ((symbol-setf-function-p symbol)
           (push-symb 'symb-setf-function)
           (push-methods `(setf ,symbol)))
